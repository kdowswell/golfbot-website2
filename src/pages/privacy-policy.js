...
<p>
  ...
  golfbot.app or App Store or Google Play GOLFBOT app (the
  “Application”).
</p>
...
<p>
  When you visit the Application, we automatically collect certain
  information about your device, including information about your web
  browser, IP address, time zone, and some of the cookies that are
  installed on your device. Additionally, as you browse the Application,
  we collect information about the individual web pages or products that
  you view, what websites or search terms referred you to the
  Application, and information about how you interact with the
  Application. We refer to this automatically-collected information as
  “Device Information.”
</p>
...
<p>
  ...
  provider, referring/exit pages, and date/time stamps. - “Web beacons,”
  “tags,” and “pixels” are electronic files used to record information
  about how you browse the Application. Additionally when you make a
  purchase or attempt to make a purchase through the Application, we
...
<p>
  ...
  orders placed through the Application (including processing your
...
<p>
  ...
  generally to improve and optimize our Application (for example, by
  generating analytics about how our customers browse and interact with
  the Application, and to assess the success of our marketing and
...
<p>
  ...
  Application--you can read more about how Google uses your Personal
...
<h2>DO NOT TRACK</h2>
<p>
  Please note that we do not alter our Application’s data collection and
...
<p>
  ...
  Application), or otherwise to pursue our legitimate business interests
...
<p>
  When you place an order through the Application, we will maintain your
...
<h2>MINORS</h2>
<p>
  The Application is not intended for individuals under the age of 13.
</p>
...
<p>
  ...
  by e-mail at support@golfbot.app.
</p>
</div>
  </Layout>
)
